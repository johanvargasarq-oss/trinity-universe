...
interface DashboardData {
  ...
  ingresosPorNegocio: { barberia: number; fries: number; slush: number; licores: number; vapers: number };
  pedidosPorNegocioHoy: { fries: number; slush: number; licores: number; vapers: number };
          ...
          <>
            ...
            <div className="grid sm:grid-cols-2 gap-6 mb-10">
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5">
                ...
                <div className="space-y-3">
                  {(["barberia", "fries", "slush", "licores", "vapers"] as const).map((id) => (
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 mb-10">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-5 gap-4">
                {(["fries", "slush", "licores", "vapers"] as const).map((id) => (
