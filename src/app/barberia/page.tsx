...
const galeria = [
  ...
  { src: "/media/barberia/gallery-11.jpg", alt: "Corte con mechón rojo en Trinity Barbería" },
  { src: "/media/barberia/gallery-12.jpg", alt: "Detalle de mechón rojo en Trinity Barbería" },
