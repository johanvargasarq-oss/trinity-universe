...
export function buildFriesOrderMessage(lines: CartLine<FriesCartItem>[], notes: string, total: number): string {
  const items = lines
    .map((l) => {
...
export function buildArepasOrderMessage(lines: CartLine<ArepaCartItem>[], notes: string, total: number): string {
  const items = lines
    .map((l) => {
...
export function buildSlushOrderMessage(lines: CartLine<SlushCartItem>[], notes: string, total: number): string {
  const items = lines
